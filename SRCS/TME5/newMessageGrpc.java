...
public final class newMessageGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<TME5.Messages.address,
      com.google.protobuf.BoolValue> getSubscribeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "subscribe",
      requestType = TME5.Messages.address.class,
      responseType = com.google.protobuf.BoolValue.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<TME5.Messages.address,
      com.google.protobuf.BoolValue> getSubscribeMethod() {
    io.grpc.MethodDescriptor<TME5.Messages.address, com.google.protobuf.BoolValue> getSubscribeMethod;
      ...
      synchronized (newMessageGrpc.class) {
        if ((getSubscribeMethod = newMessageGrpc.getSubscribeMethod) == null) {
          newMessageGrpc.getSubscribeMethod = getSubscribeMethod =
              io.grpc.MethodDescriptor.<TME5.Messages.address, com.google.protobuf.BoolValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "subscribe"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  TME5.Messages.address.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<TME5.Messages.mess,
      com.google.protobuf.BoolValue> getSendMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send",
      requestType = TME5.Messages.mess.class,
      responseType = com.google.protobuf.BoolValue.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<TME5.Messages.mess,
      com.google.protobuf.BoolValue> getSendMethod() {
    io.grpc.MethodDescriptor<TME5.Messages.mess, com.google.protobuf.BoolValue> getSendMethod;
    if ((getSendMethod = newMessageGrpc.getSendMethod) == null) {
      synchronized (newMessageGrpc.class) {
        if ((getSendMethod = newMessageGrpc.getSendMethod) == null) {
          newMessageGrpc.getSendMethod = getSendMethod =
              io.grpc.MethodDescriptor.<TME5.Messages.mess, com.google.protobuf.BoolValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  TME5.Messages.mess.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protobuf.BoolValue.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      TME5.Messages.ListOfStrings> getListChatterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "listChatter",
      requestType = com.google.protobuf.Empty.class,
      responseType = TME5.Messages.ListOfStrings.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      TME5.Messages.ListOfStrings> getListChatterMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, TME5.Messages.ListOfStrings> getListChatterMethod;
    if ((getListChatterMethod = newMessageGrpc.getListChatterMethod) == null) {
      synchronized (newMessageGrpc.class) {
        if ((getListChatterMethod = newMessageGrpc.getListChatterMethod) == null) {
          newMessageGrpc.getListChatterMethod = getListChatterMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, TME5.Messages.ListOfStrings>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  TME5.Messages.ListOfStrings.getDefaultInstance()))
  ...
  public static abstract class newMessageImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void subscribe(TME5.Messages.address request,
     ...
     * </pre>
     */
    public void send(TME5.Messages.mess request,
        io.grpc.stub.StreamObserver<com.google.protobuf.BoolValue> responseObserver) {
    ...
    public void listChatter(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<TME5.Messages.ListOfStrings> responseObserver) {
  ...
  public static final class newMessageBlockingStub extends io.grpc.stub.AbstractBlockingStub<newMessageBlockingStub> {
     ...
     * </pre>
     */
    public com.google.protobuf.BoolValue subscribe(TME5.Messages.address request) {
     ...
     * </pre>
     */
    public com.google.protobuf.BoolValue send(TME5.Messages.mess request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public TME5.Messages.ListOfStrings listChatter(com.google.protobuf.Empty request) {
      return blockingUnaryCall(
  ...
  public static final class newMessageFutureStub extends io.grpc.stub.AbstractFutureStub<newMessageFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<TME5.Messages.ListOfStrings> listChatter(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUBSCRIBE:
          serviceImpl.subscribe((TME5.Messages.address) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.BoolValue>) responseObserver);
          break;
        case METHODID_SEND:
          serviceImpl.send((TME5.Messages.mess) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.BoolValue>) responseObserver);
          break;
  ...
  private static abstract class newMessageBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return TME5.Messages.getDescriptor();
    }
