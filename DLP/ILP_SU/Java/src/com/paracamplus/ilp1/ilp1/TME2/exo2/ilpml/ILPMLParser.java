...
import com.paracamplus.ilp1.ilp1.TME2.exo2.ilpml.ILPMLListener;
...
public class ILPMLParser extends com.paracamplus.ilp1.parser.ilpml.ILPMLParser{
	...
	public IASTprogram getProgram() throws ParseException {
		try {
			...
			//CountConstant cc  = new CountConstant();
			//System.out.println("Nombre de constantes : " + cc.visit(tree.node,null));
			walker.walk(extractor, tree);	
			System.out.println("Dans ilpml listener "+extractor.getCpt());
			return tree.node;
		} catch (Exception e) {
