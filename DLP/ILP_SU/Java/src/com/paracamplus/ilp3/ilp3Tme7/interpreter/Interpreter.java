...
public class Interpreter extends com.paracamplus.ilp3.interpreter.Interpreter implements IASTvisitor<Object, ILexicalEnvironment, EvaluationException> {
	...
	public Object visit(IASTcostart iast, ILexicalEnvironment lexenv) throws EvaluationException {
		 ...
		 Object function = iast.getCouroutine().accept(this, lexenv);
		 if ( function instanceof Invocable ) {
	        ...
	        return  new CoroutineInstance(f, args, this);
