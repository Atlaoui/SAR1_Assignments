...
import antlr4.ILPMLgrammar4Tme8Parser.ExprContext;
import antlr4.ILPMLgrammar4Tme8Parser.GlobalDefContext;
...
public class ILPMLListener implements ILPMLgrammar4Tme8Listener{
	...
	public void exitHasProperty(HasPropertyContext ctx) {
		ctx.node = factory.newASThasProperty(
				ctx.prop.node,  
				ctx.obj.node);			
	}
	...
	public void exitWriteProperty(WritePropertyContext ctx) {
		ctx.node = factory.newASTwriteProperty(
				ctx.prop.node,  
				ctx.obj.node,  
				ctx.val.node);		
	}
	...
	public void exitReadProperty(ReadPropertyContext ctx) {
		ctx.node = factory.newASTreadProperty(
				ctx.prop.node,  
				ctx.obj.node);	
