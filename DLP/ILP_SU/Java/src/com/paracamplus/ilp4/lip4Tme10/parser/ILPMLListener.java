...
public class ILPMLListener implements ILPMLgrammar4Tme10Listener{
	...
	@Override
	public void enterConstexists(ConstexistsContext ctx) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void exitConstexists(ConstexistsContext ctx) {
		ctx.node= factory.newExists(factory.newVariable(ctx.getText()));
	}
