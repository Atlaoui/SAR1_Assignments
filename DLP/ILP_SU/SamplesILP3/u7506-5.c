...
ILP_Object ilpclosure5(ILP_Closure ilp_closure,
    ILP_Object t4) {
ILP_Object y2 = ilp_closure->_content.asClosure.closed_variables[0]; 
ILP_Object x1 = ilp_closure->_content.asClosure.closed_variables[1]; 
ILP_Object z3 = ilp_closure->_content.asClosure.closed_variables[2]; 
{ 
...
y2 = ILP_Value2Box(y2); 
z3 = ILP_Value2Box(z3); 
return ILP_make_closure(ilpclosure5, 1, 3, y2, x1, z3);
}
